...
## Очередь задач (в работе, не закончили в сессии 2026-05-04)

Мы их обсуждали и согласовали детали; сейчас приостановили из-за миграции
с Netlify (см. ниже). По окончании миграции — продолжаем по этому списку.
